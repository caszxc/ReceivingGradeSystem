...
function ExportButton({
  ...
  return (
    <div className="relative flex" ref={menuRef}>
      ...
      {/* Dropdown panel */}
      {open && (
        <div className="absolute left-1/2 transform -translate-x-1/2 top-full mt-2 w-44 bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
          <FormatSubMenu
            scope="all"
            label="All"
